...
public class Ricerca_RecensioneFragment extends AppCompatActivity {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = binding.b;
        ricerca_recViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
